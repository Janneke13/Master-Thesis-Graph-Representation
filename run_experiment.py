...
parser.add_argument("--seed", type=int, default=13, help="The random seed set at the start of the method.")
...
torch_geometric.seed_everything(seed=arguments.seed)
...
if arguments.model == "GCN":
    ...
    param_dict = {"hidden_nodes": arguments.hidden_nodes, "num_classes": number_classes,
                  "optimizer": arguments.optimizer, "learning_rate": arguments.learning_rate,
                  "weight_decay": arguments.weight_decay, "nr_epochs": arguments.num_epochs, "num_rel": nr_relations}
